...
#===========================================================================================#
#                                                                                           #
#   This script based on Teddysun's original script:                                        #
...
pre_install(){
    ...
    echo "Your Using Config:"

    echo -e "Server Port      : \033[41;37m ${shadowsocksport} \033[0m"
    echo -e "Password         : \033[41;37m ${shadowsockspwd} \033[0m"
    echo -e "Protocol         : \033[41;37m ${shadowsockprotocol} \033[0m"
    echo -e "obfs             : \033[41;37m ${shadowsockobfs} \033[0m"
